...
//	uint16_t j = (ch << 2) + (ch << 1) - 32*6; // Equiv.: j=(ch-32)*6 <== Convert ASCII code to font data index.
//	uint16_t j = (ch << 2) + (ch << 1) - 48*6; // Here 48 is ascii_code('0')
	uint16_t j = (ch << 2) + (ch << 1) - MY_BASE_SYMBOL*6; // Here 48 is ascii_code('0')
	ssd1306_start_data();
