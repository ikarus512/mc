...
#define DS18B20_W_PORT      PORTD
#define DS18B20_R_PORT      PIND
#define DS18B20_M_PORT      DDRD
#define DS18B20_TEMP_PIN    0
...
delayMilliseconds(750); //wait for temperature conversion
